  ...
  return (
    <div>
      <AestheticGynecologyBanner
        data={data?.data?.aesthetic_gynecology_banner}
      />
      <AestheticGynecologyMeetShahd
        data={data?.data?.aesthetic_gynecology_about}
      />
      <AboutAestheticGynecolory />
      <AestheticGynecoloryTreatments />
      <AestheticGynecologyGuide
        data={data?.data?.aesthetic_gynecology_journey}
      />
      <AestheticGynecologyTestimonial data={data?.data?.service_testimonials} />
