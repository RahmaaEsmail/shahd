    ...
    >
      {store_product_tabs?.map(item => (
        <motion.button
          ...
          whileTap="tap"
          className={cn(
            'relative px-4 min-w-[94px] h-[38px] rounded-full border border-primary text-base font-poppins uppercase overflow-hidden',
            item?.id === activeTab
              ? "font-bold bg-linear-to-r from-[#DDB2B5] to-[#EED2CD] text-white"
              : "font-medium text-primary hover:bg-linear-to-r from-[#DDB2B5] to-[#EED2CD] bg-white hover:text-white"
          )}
