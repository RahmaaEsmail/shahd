...
export default function WeightManagementTeam({ data }) {
  const { t } = useTranslation();
  const sectionRef = useRef(null);
  const isInView = useInView(sectionRef, { once: false, amount: 0.2 });

  console.log("weight managment team data", data);
  // Animation variants
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          "url('/SHAHD-IMAGE/Weight-management/352ca418788b2450d748119b5a92ace55d930229.webp')",
      ...
      <div className="relative lg:absolute container py-4 mx-auto z-10 w-full h-full inset-0 flex flex-col lg:flex-row justify-between items-stretch gap-12 lg:gap-8 px-4 sm:px-8">
        ...
        >
          ...
          <div className="flex flex-col gap-4 mt-2">
            ...
            >
              <p className="text-primary font-medium font-poppins text-xl">
