    ...
    <section className="min-h-screen relative py-6 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(254, 255, 255, 0.7) 0%, rgba(221, 178, 181, 0.5) 50%, rgba(149, 188, 170, 0.5) 75%, rgba(255, 255, 255, 0.7) 100%)",
          }}
        />
      </div>
      ...
      <div className="relative z-10 w-full mx-auto px-4">
        ...
        {/* Swiper Implementation */}
        <div className="w-full relative group px-0">
          {" "}
