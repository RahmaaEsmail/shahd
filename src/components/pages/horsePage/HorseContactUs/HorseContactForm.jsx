      ...
      <motion.form className='flex pr-4! pe-0 p-2 flex-col gap-3'>
        ...
        <motion.div>
          <Textarea
            ...
            className="border bg-transparent! border-[#868686] placeholder:text-[#868686] rounded-[30px] min-h-35 px-6 py-5 text-[#868686] font-poppins text-base font-medium"
          />
        </motion.div>
        ...
        <Button
          ...
          className="uppercase text-white bg-dark-primary! font-normal! rounded-full h-13  mt-0 text-2xl w-full cursor-pointer"
        >
          {t("Send Message")}
        </Button>
      </motion.form>
      ...
      <motion.div className='flex flex-col md:flex-row justify-between mt-3 w-full gap-6 md:gap-2'>
        <div className='flex gap-1 items-center'>
          ...
          <div className='flex flex-col'>
            <p className='text-[#9D9D9D] text-base p-0 m-0 font-poppins font-medium'>{t("Contact Us")}</p>
