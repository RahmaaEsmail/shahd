...
export default function AcademyTeam({ data }) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, rgba(221, 178, 181, 0.3) 0%, rgba(255, 255, 255, 0.5) 50%, rgba(113, 137, 162, 0.3) 100%)",
        }}
      />
      ...
      <div className="relative z-10 w-full main-container mx-auto px-4 flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:flex-col gap-2 w-full">
            ...
            >
              <p
                className={`text-secondary font-bold font-poppins text-lg ${i18n?.language == "ar" ? "text-right" : "text-left"}`}
              >
                {data[0]?.profile2_title}
              </p>
              <p
                className={`text-[#414141] text-sm leading-relaxed font-poppins ${i18n?.language == "ar" ? "text-right" : "text-left"} `}
              >
