    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          className="text-[#414141] line-clamp-3! tracking-[-0.3px] font-medium text-base  leading-6 font-poppins mb-3"
        >
        ...
        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Button
            variant="secondary"
            className={
              "text-white p-[20px_32px]  rounded-full text-lg font-normal! flex justify-center items-center w-full shadow-lg shadow-secondary/30 hover:shadow-xl transition-all"
            }
          >
