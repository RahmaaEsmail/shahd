  ...
  return (
    <section dir={isRtl ? 'rtl' : 'ltr'} className="relative overflow-hidden py-16  bg-white">
                  ...
                  <div className={`flex w-full items-center flex-col lg:flex-row ${isEven ? 'lg:flex-row-reverse' : 'lg:flex-row'}`}>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className={`flex flex-col gap-1 text-start ${isEven ? "lg:text-start" : "lg:text-end"}`}>
                          <div className={`flex mb-2 ${isEven ? "lg:justify-start" : "lg:justify-end"}`}>
                            <img src={step?.icon} alt="step icon" className="w-[47px] h-[47px] object-contain" />
                          </div>
      ...
      <div className='absolute -bottom-1 left-0 right-0 z-20 w-full h-[53px] pointer-events-none'>
        <img src="/SHAHD-IMAGE/aethesic/Rectangle 24.webp" className='w-full h-full object-cover' alt="bottom bar" />
      </div>
      <div className='absolute top-0 rotate-180 left-0 right-0 z-20 w-full h-[53px] pointer-events-none'>
        <img src="/SHAHD-IMAGE/aethesic/Rectangle 24.webp" className='w-full h-full object-cover' alt="top bar" />
      </div>
    </section>
  );
};
