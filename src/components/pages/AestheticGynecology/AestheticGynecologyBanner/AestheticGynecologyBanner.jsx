...
export default function AestheticGynecologyBanner({ data }) {
  ...
  const description1 =
    data?.[`description_1_${lang}`] ||
    data?.description_1_en ||
    t("Aesthetic Banner Desc 1");
  const description2 =
    data?.[`description_2_${lang}`] ||
    data?.description_2_en ||
    t("Aesthetic Banner Desc 2");
  const bgImage =
    "/SHAHD-IMAGE/aethesic/6953b487ed849b644340eea62251152efbd4f688.webp";
  const portraitImage =
    data?.small_image_url ||
    "/SHAHD-IMAGE/aethesic/069ebbd11859b4fb11af7a96fd1a5974030fed1e.webp";
  ...
  return (
    <div
      dir={isRtl ? "rtl" : "ltr"}
      className="relative min-h-[90vh] w-full py-20 xl:py-8 overflow-hidden flex items-center bg-[#1a1a1a]"
    >
          ...
          <div className="xl:col-span-6  flex flex-col items-center xl:items-start text-center xl:text-start gap-8 md:gap-12">
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #D19B9B 0%, #B6C7D6 100%)",
                  boxShadow:
