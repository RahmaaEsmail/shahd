...
export default function AboutContact() {
  ...
  return (
    <motion.div
      ...
      className='py-8 lg:py-4 items-stretch grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0 overflow-x-hidden'
    >
      {/* Left Column - Image */}
      <motion.div
        ...
        className='w-full h-full order-2 lg:order-1   rounded-r-none lg:rounded-tr-[50px] lg:rounded-br-[50px] overflow-hidden'
      >
        <motion.div
          whileHover={{ scale: 1.05 }}
          transition={{ duration: 0.4 }}
          className="relative h-75 lg:h-full w-full"
        >
          <Image
            loading='lazy'
            src="/SHAHD-IMAGE/About/contact.webp"
            fill
